...
data_arg.add_argument('--val_dir', type=str, default='./net/val')
data_arg.add_argument('--random_seed', type=int, default=20)
data_arg.add_argument('--num_classes', type=int, default=241)
...
model_arg.add_argument('--model_path', type=str, default='./model/dfcn.pth')
model_arg.add_argument('--num_clusters', type=int, default=64)
...
train_arg.add_argument('--num_workers', type=int, default=8)
